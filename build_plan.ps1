...
Select-Object @{Name="Device Drivers";Expression={$_.DisplayName}}, Name,@{n="Version";e={(Get-Item $_.pathname).VersionInfo.FileVersion}} | 
Export-Csv drivers.csv -NoTypeInformation

# Get Services
Get-WmiObject -Class win32_service | 
Select-Object @{Name="Services/Daemons";Expression={$_.DisplayName}}, StartMode | 
Export-Csv services.csv -NoTypeInformation

# Get Installed Hotfixes, Applications, and Updates
Get-Hotfix | Select-Object @{Name="Computer Name";Expression={$_.CSName}}, HotFixID, Description | 
